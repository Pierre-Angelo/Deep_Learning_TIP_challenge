...
%metric = accuracyMetric(ClassificationMode="multilabel", AverageType="macro");
%metric = precisionMetric(ClassificationMode="multilabel", AverageType="macro");
metric = fScoreMetric(ClassificationMode="multilabel", AverageType="macro");
